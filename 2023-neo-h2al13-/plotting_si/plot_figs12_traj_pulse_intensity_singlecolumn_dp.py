...
dirs = ["../rerun_largebasis_dp/eq_rt_pulse_5e-3", "../rerun_largebasis_dp/eq_neo_pulse_5e-3", "../rerun_largebasis_dp/eq_rt_pulse_5e-3_D", "../rerun_largebasis_dp/eq_neo_pulse_5e-3_D",
        "../rerun_largebasis_dp/eq_rt_pulse_9e-3", "../rerun_largebasis_dp/eq_neo_pulse_9e-3", "../rerun_largebasis_dp/eq_rt_pulse_9e-3_D", "../rerun_largebasis_dp/eq_neo_pulse_9e-3_D",
        "../rerun_largebasis_dp/eq_rt_pulse_2e-2", "../rerun_largebasis_dp/eq_neo_pulse_2e-2", "../rerun_largebasis_dp/eq_rt_pulse_2e-2_D", "../rerun_largebasis_dp/eq_neo_pulse_2e-2_D"
        ]
...
clp.adjust(tight_layout=False, savefile="figs12_bond_length_dynamics_pulse_intensity_sc_dp.pdf")
