...
figure, ax = clp.initialize(1, 1, width=4.3, height=4.3*0.618, LaTeX=True, fontsize=12,
    labelsize=14, labelthem=False, labelthemPosition=[-0.02, 1.02], sharey=False, return_fig_args=True)
...
clp.plotone(xs, y1s, axes[0], colors=colors, labels=labels_eh, lw=1.5,
    showlegend=True, legendFontSize=9.5,
    xlim=[0,100], ylim=[0.935, 1.735], xlabel="time [fs]",
...
clp.adjust(tight_layout=False, savefile="fig3_pt_eh_single.tiff")
