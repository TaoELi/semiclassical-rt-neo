...
methods = [
           ...
           "../data/pgrad_0_mv_0_rescf_0_dtsm/",
           ]
...
colors_fig1 = [clp.black, clp.navy_blue, "0.5"]
colors_fig2 = [clp.black, clp.navy_blue]
linestyles_dashed = ["-", "-", "-", "--", "--", "--"]

labels_fig1 = [r"FPB", r"TPB original", r"TPB basis center"]
...
clp.plotone(x3s, y3s, axes[1], colors=colors_fig2, labels=labels_fig1, lw=1.5, ylim=[-8.0, 1],
        showlegend=False, legendFontSize=8, alphaspacing=0.05, #xlabel="time [fs]", 
        ylabel=r"$\Delta E_{\rm tot}$ [$\times 10^{-3}$a.u.]")
...
clp.adjust(tight_layout=True, savefile="traj_ohba_original.pdf")
