...
labels = ["cavity resonance with H-CN stretch"]
...
ab = AnnotationBbox(imagebox, (730, 5.5), frameon=False)
ab.set(zorder=-1)
axes[0,0].add_artist(ab)

clp.adjust(tight_layout=False, savefile="fig2_mun_incav_rmlines.pdf")
