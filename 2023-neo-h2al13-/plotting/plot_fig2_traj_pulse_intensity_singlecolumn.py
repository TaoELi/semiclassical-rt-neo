...
dirs = ["../run_pbe_6-31gd/eq_rt_pulse_5e-3", "../run_pbe_6-31gd/eq_neo_pulse_5e-3", "../run_pbe_6-31gd/eq_rt_pulse_5e-3_D", "../run_pbe_6-31gd/eq_neo_pulse_5e-3_D",
        "../run_pbe_6-31gd/eq_rt_pulse_9e-3", "../run_pbe_6-31gd/eq_neo_pulse_9e-3", "../run_pbe_6-31gd/eq_rt_pulse_9e-3_D", "../run_pbe_6-31gd/eq_neo_pulse_9e-3_D",
        "../run_pbe_6-31gd/eq_rt_pulse_2e-2", "../run_pbe_6-31gd/eq_neo_pulse_2e-2", "../run_pbe_6-31gd/eq_rt_pulse_2e-2_D", "../run_pbe_6-31gd/eq_neo_pulse_2e-2_D",
        ]
...
clp.adjust(tight_layout=False, savefile="fig2_bond_length_dynamics_pulse_intensity_sc.pdf")
