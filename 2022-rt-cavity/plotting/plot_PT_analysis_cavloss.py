...
def prepare_PT_Figb():
    ...
    pathname_new = "../oHBA/tddft_S0S1_geometry/incav_HOMOLUMO_cavloss/Geom_0/"
    ...
    labels = [r"H--O$_{\rm D}$ cavity off", r"H--O$_{\rm A}$ cavity off",
              ...
              r"H--O$_{\rm D}$ $\tau_c$ = 10 fs", r"H--O$_{\rm A}$ $\tau_c$ = 10 fs"]
...
def prepare_PT_Figc():
    ...
    pathname_new = "../oHBA/tddft_S0S1_geometry/incav_HOMOLUMO_cavloss/Geom_10/"
...
def prepare_PT_Figd():
    ...
    pathname_new = "../oHBA/tddft_S0S1_geometry/incav_HOMOLUMO_cavloss/Geom_20/"
...
def prepare_spectrum(idx):
    ...
    pathname_new = "../oHBA/tddft_S0S1_geometry/incav_LR_cavloss/Geom_%d_LR/" %idx
    ...
    ys = [sp_out, sp_in, sp_new*3]
    colors = [clp.navy_blue, clp.red, clp.green]
    labels = ["cavity off", "cavity on", r"$\tau_c$ = 10 fs"]
    return xs, ys, colors, labels
...
clp.adjust(savefile="PT_cavloss.pdf")
